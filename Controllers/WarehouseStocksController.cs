...
using Application.Features.Inventory.WarehouseStock.Commands.AddWarehouseProducts;
using Application.Features.Inventory.WarehouseStocks.Commands.DeleteWarehouseStock;
using Application.Features.Inventory.WarehouseStocks.Commands.UpdateWarehouseStock;
using Application.Features.Inventory.WarehouseStocks.Queries.GetWarehouseStockPaged;
...
namespace InventoryManagementSystemAPI.Controllers
{
    ...
    [OutputCache(Tags = [CacheEntities.WarehouseStock])]
    ...
    public async Task<IActionResult> Get(Guid warehouseId, [FromQuery] int pageNumber = 1, [FromQuery] int pageSize = 10, CancellationToken ct = default)
        {
