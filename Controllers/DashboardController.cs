using Application.Features.Dashboard.Queries.GetDashboardData;
...
namespace InventoryManagementSystemAPI.Controllers
{
    ...
    {
    [HttpGet]
    [OutputCache(Tags = [CacheEntities.Product, CacheEntities.Category, CacheEntities.Customer, CacheEntities.Supplier, CacheEntities.Order, CacheEntities.Invoice, CacheEntities.Warehouse, CacheEntities.WarehouseStock, CacheEntities.Adjustment, CacheEntities.Document, CacheEntities.Person, CacheEntities.Address, CacheEntities.City, CacheEntities.Country, CacheEntities.ContactInfo, CacheEntities.User])]
