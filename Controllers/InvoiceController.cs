...
using Application.Features.Transactions.Invoice.Commands.CreateInvoice;
using Application.Features.Transactions.Invoice.Queries.GetInvoice;
using Application.Features.Transactions.Invoice.Queries.GetInvoicePDF;
...
public class InvoiceController(IMediator sender) : ApiController
    ...
    [OutputCache(Tags = [CacheEntities.Invoice])]
