...
using Application.Common.Constants;
 using Application.Features.Inventory.Categories.Commands.CreateCategory;
using Application.Features.Inventory.Categories.Commands.DeleteCategory;
using Application.Features.Inventory.Categories.Commands.UpdateCategory;
using Application.Features.Inventory.Categories.DTOs;
using Application.Features.Inventory.Categories.Queries.GetCategory;
using Application.Features.Inventory.Categories.Queries.GetCategoryPaged;
using MediatR;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using Microsoft.AspNetCore.OutputCaching;
using Contracts.Requests.Categories;
...
{
    [HttpGet]
    [OutputCache(Tags = [CacheEntities.Category])]
