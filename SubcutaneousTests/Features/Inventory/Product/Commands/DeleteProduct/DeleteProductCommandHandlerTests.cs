...
namespace SubcutaneousTests.Features.Inventory.Product.Commands.DeleteProduct;
...
public class DeleteProductCommandHandlerTests
{
    ...
    public DeleteProductCommandHandlerTests(WebAppFactory factory, ITestOutputHelper output)
    {
