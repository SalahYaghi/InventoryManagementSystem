...
namespace SubcutaneousTests.Features.Inventory.Product.Queries.GetProduct;
...
public class GetProductQueryHandlerTests
{
    ...
    public GetProductQueryHandlerTests(WebAppFactory factory, ITestOutputHelper output)
    {
