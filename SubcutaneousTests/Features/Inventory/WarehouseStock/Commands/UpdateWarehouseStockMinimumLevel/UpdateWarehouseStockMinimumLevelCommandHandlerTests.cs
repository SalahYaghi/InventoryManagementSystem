...
namespace SubcutaneousTests.Features.Inventory.WarehouseStock.Commands.UpdateWarehouseStockMinimumLevel;

[Collection(WebAppFactoryCollection.CollectionName)]
public class UpdateWarehouseStockMinimumLevelCommandHandlerTests
{
    private readonly IMediator _mediator;
    private readonly IAppDbContext _context;
    private readonly ITestOutputHelper _output;

    public UpdateWarehouseStockMinimumLevelCommandHandlerTests(WebAppFactory factory, ITestOutputHelper output)
    {
