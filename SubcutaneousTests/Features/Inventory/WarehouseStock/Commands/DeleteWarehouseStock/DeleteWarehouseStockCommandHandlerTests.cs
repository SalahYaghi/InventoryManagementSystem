...
namespace SubcutaneousTests.Features.Inventory.WarehouseStock.Commands.DeleteWarehouseStock;

[Collection(WebAppFactoryCollection.CollectionName)]
public class DeleteWarehouseStockCommandHandlerTests
{
    private readonly IMediator _mediator;
    private readonly IAppDbContext _context;
    private readonly ITestOutputHelper _output;

    public DeleteWarehouseStockCommandHandlerTests(WebAppFactory factory, ITestOutputHelper output)
    {
