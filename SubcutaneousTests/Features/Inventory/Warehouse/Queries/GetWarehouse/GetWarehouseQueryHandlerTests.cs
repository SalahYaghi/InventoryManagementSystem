...
namespace SubcutaneousTests.Features.Inventory.Warehouse.Queries.GetWarehouse;
...
public class GetWarehouseQueryHandlerTests
{
    ...
    public GetWarehouseQueryHandlerTests(WebAppFactory factory, ITestOutputHelper output)
    {
