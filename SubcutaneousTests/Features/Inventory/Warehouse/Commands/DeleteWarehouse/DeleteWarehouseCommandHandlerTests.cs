...
namespace SubcutaneousTests.Features.Inventory.Warehouse.Commands.DeleteWarehouse;
...
public class DeleteWarehouseCommandHandlerTests
{
    ...
    public DeleteWarehouseCommandHandlerTests(WebAppFactory factory, ITestOutputHelper output)
    {
