...
namespace SubcutaneousTests.Features.Inventory.Adjustment.Queries.GetAdjustmentDetail;

[Collection(WebAppFactoryCollection.CollectionName)]
public class GetAdjustmentDetailQueryHandlerTests
{
    private readonly IMediator _mediator;
    private readonly IAppDbContext _context;
    private readonly ITestOutputHelper _output;

    public GetAdjustmentDetailQueryHandlerTests(WebAppFactory factory, ITestOutputHelper output)
    {
