...
namespace SubcutaneousTests.Features.Inventory.Adjustment.Queries.GetAdjustment;

[Collection(WebAppFactoryCollection.CollectionName)]
public class GetAdjustmentQueryHandlerTests
{
    private readonly IMediator _mediator;
    private readonly IAppDbContext _context;
    private readonly ITestOutputHelper _output;

    public GetAdjustmentQueryHandlerTests(WebAppFactory factory, ITestOutputHelper output)
    {
