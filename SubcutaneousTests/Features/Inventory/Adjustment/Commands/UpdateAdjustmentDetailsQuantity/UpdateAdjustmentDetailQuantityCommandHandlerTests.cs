...
public class UpdateAdjustmentDetailQuantityCommandHandlerTests
{
    private readonly IMediator _mediator;
    private readonly IAppDbContext _context;
    private readonly ITestOutputHelper _output;

    public UpdateAdjustmentDetailQuantityCommandHandlerTests(WebAppFactory factory, ITestOutputHelper output)
    {
