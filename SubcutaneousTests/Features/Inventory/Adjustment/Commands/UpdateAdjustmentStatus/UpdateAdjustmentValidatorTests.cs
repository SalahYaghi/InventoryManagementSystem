...
namespace SubcutaneousTests.Features.Inventory.Adjustment.Commands.UpdateAdjustmentStatus;
...
public class CreateAdjustmentCommandValidatorTests
{
    ...
    public void Validate_WithValidData_ShouldNotHaveValidationError()
    {
        ...
        AdjustmentDetailCommands = new List<CreateAdjustmentDetailInnerCommand>(){
            c
        }};
