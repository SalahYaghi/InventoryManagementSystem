...
namespace SubcutaneousTests.Features.Inventory.Adjustment.Commands.CreateAdjustmentDetail;
...
public class CreateAdjustmentCommandValidatorTests
{
    ...
    public void Validate_WithValidData_ShouldNotHaveValidationError()
    {
        ...
        var command = new CreateAdjustmentCommand { WarehouseId = Guid.NewGuid(), AdjustmentReason = AdjustmentReason.ExtraFound, Notes = "Valid" , AdjustmentDetailCommands = new() { 
        c } };
...
public class UpdateAdjustmentCommandValidatorTests
{
    ...
    [Fact] public void Validate_WithValidData_ShouldNotHaveValidationError() { var c = new UpdateAdjustmentCommand { Id = Guid.NewGuid(), Notes = "Valid" }; _validator.TestValidate(c).ShouldNotHaveAnyValidationErrors(); }
