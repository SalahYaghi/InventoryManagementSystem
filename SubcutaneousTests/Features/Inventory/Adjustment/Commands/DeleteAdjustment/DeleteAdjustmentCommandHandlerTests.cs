...
namespace SubcutaneousTests.Features.Inventory.Adjustment.Commands.DeleteAdjustment;

[Collection(WebAppFactoryCollection.CollectionName)]
public class DeleteAdjustmentCommandHandlerTests
{
    private readonly IMediator _mediator;
    private readonly IAppDbContext _context;
    private readonly ITestOutputHelper _output;

    public DeleteAdjustmentCommandHandlerTests(WebAppFactory factory, ITestOutputHelper output)
    {
