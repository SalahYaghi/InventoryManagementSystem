...
namespace SubcutaneousTests.Features.Inventory.Adjustment.Commands.DeleteAdjustmentDetail;

[Collection(WebAppFactoryCollection.CollectionName)]
public class DeleteAdjustmentDetailCommandHandlerTests
{
    private readonly IMediator _mediator;
    private readonly IAppDbContext _context;
    private readonly ITestOutputHelper _output;

    public DeleteAdjustmentDetailCommandHandlerTests(WebAppFactory factory, ITestOutputHelper output)
    {
