...
namespace SubcutaneousTests.Features.Inventory.Products.Commands.CreateProduct;
...
public class CreateProductTests
{
    ...
    public CreateProductTests(WebAppFactory factory, ITestOutputHelper output)
    {
