...
namespace SubcutaneousTests.Features.Inventory.Category.Queries.GetCategory;
...
public class GetCategoryQueryHandlerTests
{
    ...
    public GetCategoryQueryHandlerTests(WebAppFactory factory, ITestOutputHelper output)
    {
