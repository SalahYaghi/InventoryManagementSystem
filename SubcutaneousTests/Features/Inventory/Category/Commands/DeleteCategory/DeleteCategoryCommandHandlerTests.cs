...
namespace SubcutaneousTests.Features.Inventory.Category.Commands.DeleteCategory;
...
public class DeleteCategoryCommandHandlerTests
{
    ...
    public DeleteCategoryCommandHandlerTests(WebAppFactory factory, ITestOutputHelper output)
    {
