...
namespace SubcutaneousTests.Features.Parties.Employees.Commands.DeleteEmployee;
...
public class DeleteEmployeeCommandHandlerTests
{
    ...
    public DeleteEmployeeCommandHandlerTests(WebAppFactory factory)
    {
    ...
    {
        var result = await _mediator.Send(new DeleteEmployeeCommand(Guid.NewGuid()));
