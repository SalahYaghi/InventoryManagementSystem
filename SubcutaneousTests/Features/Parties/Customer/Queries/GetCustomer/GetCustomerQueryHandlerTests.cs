...
namespace SubcutaneousTests.Features.Parties.Customer.Queries.GetCustomer;
...
public class GetCustomerQueryHandlerTests
{
    ...
    public GetCustomerQueryHandlerTests(WebAppFactory factory)
    {
    ...
    {
        var result = await _mediator.Send(new GetCustomerQuery(Guid.NewGuid()));
