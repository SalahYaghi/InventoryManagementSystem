...
namespace SubcutaneousTests.Features.Parties.Suppliers.Commands.CreateSupplier;
...
public class CreateSupplierValidatorTests
{
    ...
    [Fact]
    public async Task Validate_WithInvalidContact_ShouldHaveValidationError()
    {
        var command = CreateValidCommand() with { Contact = new CreateContactInfoCommand {  PhoneNumber = "+970599999999", AlternitavePhoneNumber = "+970598888888" } };
