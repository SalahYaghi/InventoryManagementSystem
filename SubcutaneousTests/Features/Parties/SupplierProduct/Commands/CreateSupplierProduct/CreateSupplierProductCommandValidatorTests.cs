...
namespace SubcutaneousTests.Features.Parties.SupplierProduct.Commands.CreateSupplierProduct;

public class CreateSupplierProductCommandValidatorTests
{
    private readonly CreateSupplierProductCommandValidator _validator = new();
    ...
    private static CreateSupplierProductCommand CreateValidCommand()
    {
        return new CreateSupplierProductCommand
        {
