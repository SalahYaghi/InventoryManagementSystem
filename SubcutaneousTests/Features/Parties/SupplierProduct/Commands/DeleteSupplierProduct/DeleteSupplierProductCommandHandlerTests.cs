...
namespace SubcutaneousTests.Features.Parties.SupplierProduct.Commands.DeleteSupplierProduct;

[Collection(WebAppFactoryCollection.CollectionName)]
public class DeleteSupplierProductCommandHandlerTests
{
    private readonly IMediator _mediator;
    private readonly IAppDbContext _context;

    public DeleteSupplierProductCommandHandlerTests(WebAppFactory factory)
    {
    ...
    {
        var result = await _mediator.Send(new DeleteSupplierProductCommand(Guid.NewGuid(), Guid.NewGuid()));
