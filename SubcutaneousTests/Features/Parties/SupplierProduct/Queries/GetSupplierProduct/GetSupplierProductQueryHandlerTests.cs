...
namespace SubcutaneousTests.Features.Parties.SupplierProduct.Queries.GetSupplierProduct;

[Collection(WebAppFactoryCollection.CollectionName)]
public class GetSupplierProductQueryHandlerTests
{
    private readonly IMediator _mediator;
    private readonly IAppDbContext _context;

    public GetSupplierProductQueryHandlerTests(WebAppFactory factory)
    {
    ...
    {
        var result = await _mediator.Send(new GetSupplierProductQuery(Guid.NewGuid(), Guid.NewGuid()));
