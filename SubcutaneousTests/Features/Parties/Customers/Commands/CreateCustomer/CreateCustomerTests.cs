...
namespace SubcutaneousTests.Features.Parties.Customers.Commands.CreateCustomer;
...
public class CreateCustomerTests
{
    ...
    public CreateCustomerTests(WebAppFactory factory, ITestOutputHelper output)
    {
