...
namespace SubcutaneousTests.Features.Parties.Person.Queries.GetPerson;
...
public class GetPersonQueryHandlerTests
{
    ...
    public GetPersonQueryHandlerTests(WebAppFactory factory)
    {
    ...
    {
        var result = await _mediator.Send(new GetPersonQuery(Guid.NewGuid()));
