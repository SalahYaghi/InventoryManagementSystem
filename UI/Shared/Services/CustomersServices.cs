...
namespace UI.Services
{
    ...
    {
        public static async Task<ApiResult<List<CustomerForListDto>>> GetAll()
        {
            var response = await _inventoryClient.GetAsync($"{CustomersRoute}");
            return await ReadResponse<List<CustomerForListDto>>(response);
        }
