...
namespace UI.Services
{
    ...
    {
        public static async Task<ApiResult<List<CategoryDto>>> GetAll(int pageNumber = 1, int pageSize = 60)
        {
            var response = await _inventoryClient.GetAsync($"{CategoriesRoute}?pageNumber={pageNumber}&pageSize={pageSize}");
