...
namespace UI.Forms.People
{
        ...
        private bool firstCall = true;
            ...
            var data = result.Data;
                ...
                _allPeople = data.Items;
            this.dgvPeople.SetData(_allPeople);
          
            cmbCity.LoadData<PersonForListDto>(_allPeople,
        p => p.City);
            cmbCity.IndexChanged += ApplyCurrentView;

            cmbGender.LoadData<PersonForListDto>(_allPeople,
        p => p.Gender);
            cmbGender.IndexChanged += ApplyCurrentView;

            cmbCountry.LoadData<PersonForListDto>(_allPeople,
        p => p.Country);
            cmbCountry.IndexChanged += ApplyCurrentView;

            var cols = dgvPeople.DgvCustom.GetColumnNamesExcept(new HashSet<string>() {
                "Id","DocumentId"
            });
