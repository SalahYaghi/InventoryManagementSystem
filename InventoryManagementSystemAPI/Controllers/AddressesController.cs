...
using Contract.Features.References.Addresses.Commands.DeleteAddress;
using Contract.Features.References.Addresses.Commands.UpdateAddress;
using Contract.Features.References.Addresses.DTOs;
using Contract.Features.References.Addresses.Queries.GetAddress;
using Microsoft.AspNetCore.Routing;

using Contract.Features.References.Addresses.Queries.GetAddressPaged;
using MediatR;
...
{
    [HttpGet]
    [OutputCache(Tags = [CacheEntities.Address], PolicyName = nameof(AuthenticatedUserCachePolicy), VaryByQueryKeys = ["pageNumber", "pageSize"])]
    ...
    [OutputCache(Tags = [CacheEntities.Address], PolicyName = nameof(AuthenticatedUserCachePolicy), VaryByRouteValueNames = ["addressId"])]
    [ProducesResponseType(typeof(object), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status401Unauthorized)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status403Forbidden)]
