...
using Contract.Features.Parties.Supplier.Commands.DeleteSupplier;
...
using Contract.Features.Parties.SupplierProducts.Commands.CreateSupplierProduct;
using Contract.Features.Parties.SupplierProducts.Commands.DeleteSupplierProduct;
using Contract.Features.Parties.SupplierProducts.Commands.UpdateSupplierProduct;
using Contract.Features.Parties.SupplierProducts.Queries.GetSupplierProduct;
...
{
    [HttpGet]
    [OutputCache(Tags = [CacheEntities.Supplier], PolicyName = nameof(AuthenticatedUserCachePolicy))]
    ...
    [OutputCache(Tags = [CacheEntities.Supplier], PolicyName = nameof(AuthenticatedUserCachePolicy), VaryByRouteValueNames = ["supplierId"])]
    [ProducesResponseType(typeof(object), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status401Unauthorized)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status403Forbidden)]
    ...
    [OutputCache(Tags = [CacheEntities.SupplierProduct], PolicyName = nameof(AuthenticatedUserCachePolicy), VaryByRouteValueNames = ["supplierId"])]
    [ProducesResponseType(typeof(object), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status401Unauthorized)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status403Forbidden)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status404NotFound)]
    ...
    [EndpointSummary("Retrieves paged suppliers.")]
    [EndpointDescription("Returns a paginated list of suppliers.")]
    [EndpointName("GetSupplierProducts")]
    [MapToApiVersion("1.0")]
    [Authorize(Roles = RoleConstants.Admin + "," + RoleConstants.PurchasesUser + "," + RoleConstants.Viewer)]
    ...
    [OutputCache(Tags = [CacheEntities.SupplierProduct], PolicyName = nameof(AuthenticatedUserCachePolicy), VaryByRouteValueNames = ["supplierId", "productId"])]
    [ProducesResponseType(typeof(object), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status401Unauthorized)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status403Forbidden)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status404NotFound)]
