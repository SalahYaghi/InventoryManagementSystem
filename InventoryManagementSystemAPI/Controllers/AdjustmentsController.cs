...
public class AdjustmentsController(IMediator sender) : ApiController
    {
    [HttpGet]
    [OutputCache(Tags = [CacheEntities.Adjustment], PolicyName = nameof(AuthenticatedUserCachePolicy), VaryByQueryKeys = ["pageNumber", "pageSize"])]
    ...
    [OutputCache(Tags = [CacheEntities.Adjustment], PolicyName = nameof(AuthenticatedUserCachePolicy), VaryByRouteValueNames = ["AdjustmentId"])]
    ...
    [OutputCache(Tags = [CacheEntities.AdjustmentDetail], PolicyName = nameof(AuthenticatedUserCachePolicy), VaryByRouteValueNames = ["AdjustmentId"])]
    [ProducesResponseType(typeof(object), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status401Unauthorized)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status403Forbidden)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status404NotFound)]
    ...
    [EndpointName("GetAdjustmentDetails")]
    [MapToApiVersion("1.0")]
    [Authorize(Roles = RoleConstants.Admin + "," + RoleConstants.WarehouseUser + "," + RoleConstants.Viewer)]
    ...
    [OutputCache(Tags = [CacheEntities.AdjustmentDetail], PolicyName = nameof(AuthenticatedUserCachePolicy), VaryByRouteValueNames = ["detailId"])]
    [ProducesResponseType(typeof(object), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status401Unauthorized)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status403Forbidden)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status404NotFound)]
