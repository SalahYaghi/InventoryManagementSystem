...
using Contract.Features.References.Cities.Queries.GetCityPaged;
 using Contract.Features.References.Countries.Commands.CreateCountry;
using Contract.Features.References.Countries.Commands.DeleteCountry;
using Contract.Features.References.Countries.Commands.UpdateCountry;
using Contract.Features.References.Countries.DTOs;
using Contract.Features.References.Countries.Queries.GetCountry;
...
{
    [HttpGet]
    [OutputCache(Tags = [CacheEntities.Country], PolicyName = nameof(AuthenticatedUserCachePolicy))]
    ...
    [OutputCache(Tags = [CacheEntities.City], PolicyName = nameof(AuthenticatedUserCachePolicy), VaryByRouteValueNames = ["countryId"])]
    [ProducesResponseType(typeof(object), StatusCodes.Status200OK)]
    ...
    [OutputCache(Tags = [CacheEntities.Country], PolicyName = nameof(AuthenticatedUserCachePolicy), VaryByRouteValueNames = ["countryId"])]
    [ProducesResponseType(typeof(object), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status404NotFound)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status500InternalServerError)]
    [Authorize(Roles = RoleConstants.Admin + "," + RoleConstants.Viewer)]
